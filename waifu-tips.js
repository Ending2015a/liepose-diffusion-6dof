...
const live2d_settings = {
    ...
    // 模型设置
    'modelName': 'hiyori_free_t08',                      // 默认加载的模型名称，仅在无本地记录的情况下有效
    ...
    //看板娘样式设置
    'live2dHeight': 1200,                        // 看板娘高度，不需要单位
    'live2dWidth': 1000,                         // 看板娘宽度，不需要单位
    'waifuMinWidth': 'disable',                 // 页面小于宽度小于指定数值时隐藏看板娘，例如 'disable'(禁用)，推荐 '1040px'
    'waifuEdgeSide': 'left:-300',                 // 看板娘贴边方向，例如 'left:0'(靠左 0px)，'right:30'(靠右 30px)，可以被下面的模型设置覆盖
    // 其他杂项设置
